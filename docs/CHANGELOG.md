...
| 2026-09-02 | `NFR-P-02`, `NFR-P-05`, `NFR-P-06`, `NFR-P-08`, `NFR-P-09`, `NFR-P-10`, `NFR-P-12`, `NFR-P-13` | **Dropped** | CR-01 — eight Product NFRs; speed, capacity, robustness and portability retained | `NFR-P-13` was the requirement that carried the SRA-derived security objectives, so dropping it removes `SEC-01`–`SEC-14` from the committed set along with it |
